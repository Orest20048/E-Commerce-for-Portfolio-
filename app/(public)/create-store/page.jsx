    ...
    const fetchSellerStatus = async () => {
        ...
        try {
            ...
            if(['approved' , 'rejected','pending'].includes(data.status)){
                ...
                switch (data.status) {
                    case "approved":
                        setMessage("Your Store has been approved, you can new add products to your store from dashboard")
    ...
    if(!user){
        return(
            <div className="min-h-[80vh] mx-6 flex items-center justify-center text-slate-400">
                <h1 className="text-2xl sm:text-4xl font-semibold">Please  <span className="text-slate-500">
